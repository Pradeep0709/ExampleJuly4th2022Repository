...
public class ExcelAssignmentDemo8 {
	...
	private static void readWriteContent()
	{
		...
		try
		{
			fin=new FileInputStream("D:\\excel\\Assignment9.xlsx");
			...
			fout=new FileOutputStream("D:\\excel\\Assignment9.xlsx");
			wb.write(fout);
